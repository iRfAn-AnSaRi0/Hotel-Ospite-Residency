...
const Hero = () => {
  return (
    <>
      <header className="relative min-h-[78svh] md:h-[870px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full py-12">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-7xl font-bold text-white font-headline leading-[1.1] mb-4 md:mb-6 max-w-2xl tracking-tight">
            Welcome to <br />
            <span className="text-amber-400">Comfort &amp; Serenity</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-emerald-50/90 font-medium mb-8 md:mb-10 max-w-lg leading-relaxed">
      ...
      <section className="py-10 md:py-12 bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 -mt-12 md:-mt-24 relative z-20">
            <div className="bg-surface-container-lowest p-6 md:p-8 rounded-2xl editorial-shadow flex flex-col gap-4 border-b-4 border-amber-400">
              <span className="material-symbols-outlined text-primary text-4xl">distance</span>
              <h3 className="text-xl md:text-2xl font-bold text-primary font-headline tracking-tight">3 km from Main Town</h3>
              <p className="text-on-surface-variant text-sm">Conveniently located for both comfort and city access.</p>
            </div>
            <div className="bg-surface-container-lowest p-6 md:p-8 rounded-2xl editorial-shadow flex flex-col gap-4 border-b-4 border-primary md:translate-y-8">
              <span className="material-symbols-outlined text-primary text-4xl">medical_services</span>
              <h3 className="text-xl md:text-2xl font-bold text-primary font-headline tracking-tight">7 min to STNM Hospital</h3>
            ...
            <div className="bg-surface-container-lowest p-6 md:p-8 rounded-2xl editorial-shadow flex flex-col gap-4 border-b-4 border-amber-400">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-primary font-headline tracking-tight">30-seat Dining Hall</h3>
      ...
      <section className="py-16 md:py-24 bg-surface-container-low">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="mb-10 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-primary font-headline mb-4 tracking-tight">Our Features</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-px bg-outline-variant/10 rounded-3xl overflow-hidden shadow-sm">
            {facilities.map(([icon, label]) => (
              <div key={label} className="bg-white p-5 md:p-8 flex flex-col items-center justify-center gap-3 text-center transition-colors hover:bg-emerald-50">
      ...
      <section className="py-16 md:py-24 bg-surface overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="mb-10 md:mb-16 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-primary font-headline mb-4 tracking-tight italic">Room Categories</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {rooms.map((room, idx) => (
              <div key={room.name} className="group">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-primary mb-1">{room.name}</h3>
      ...
      <section className="py-16 md:py-24 bg-surface-container-highest/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-primary font-headline mb-10 md:mb-12 tracking-tight">Nearby Attractions</h2>
          <div className="flex overflow-x-auto pb-12 gap-6 no-scrollbar snap-x">
            {attractions.map(([title, desc, dist, img]) => (
              <div key={title} className="flex-none w-[85vw] sm:w-80 snap-start bg-white rounded-2xl overflow-hidden editorial-shadow group">
